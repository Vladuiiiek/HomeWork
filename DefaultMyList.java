...
public class DefaultMyList {
	...
	private class ListIteratorImpl extends IteratorImpl implements ListIterator {
		...
		public Object previous() {
			...
			if (step < 0) {
				...
				return DefaultMyList.this.arr[step];
			}
		}
		...
		public void set(Object e) {
			...
			isCalledSet = true;
			arr[step >= 0 ? (isCalledPrevious ? step : (isCalledNext() ? step - 1 : 0)) : -1] = e;
			if (!isCalledPrevious) {
	...
	private class IteratorImpl implements Iterator<Object> {
		...
		public boolean hasNext() {
			return DefaultMyList.this.size > this.step;
		}
		...
		public void remove() {
			if (!isCalledNext) {
				...
				isCalledRemove = true;
				DefaultMyList.this.deleteByIndex(this.step - 1 > 0 ? this.step - 1 : (this.step - 1 < 0 ? -1 : 0));
				step--;
			}
		}
